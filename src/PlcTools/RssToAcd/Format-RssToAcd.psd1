# Module manifest for module 'Format-RssToAcd'
#
# Generated by: Emerson Martins Brito
#
# Generated on: 04/07/2025
#
...
@{
  ...
  GUID              = 'b114b3e3-1a58-4aaf-ab62-a2e9f3a74a2d'
  ...
  FileList          = @('Format-RssToAcd.psm1', 'RegexMap.json', 'Format-RssToAcd-Help-en-US.xml', 'Format-RssToAcd-Help-pt-BR.xml', 'Format-RssToAcd-Help.xml')
  ...
  PrivateData       = @{
    ...
    PSData = @{
      ...
      ProjectUri   = 'https://github.com/Emersonmrbr/PowershellModules.git'
